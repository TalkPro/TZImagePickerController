...
- (void)setResult:(id)result {
    _result = result;
    BOOL allowPickingImage = [TZImageManager manager].allowPickingImage;
    //[[[NSUserDefaults standardUserDefaults] objectForKey:@"tz_allowPickingImage"] isEqualToString:@"1"];
    BOOL allowPickingVideo = [TZImageManager manager].allowPickingVideo;
    //[[[NSUserDefaults standardUserDefaults] objectForKey:@"tz_allowPickingVideo"] isEqualToString:@"1"];
